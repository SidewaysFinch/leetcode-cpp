 ...
 *   (only other possibility is subtracting k from min and adding k to max which always makes difference bigger so we ignore this)
 * Thus our plan is to compare the difference between the max and min with the difference between the a new min calculated
 */
